...
const FAQ = () => {
  ...
  return (
    <div className="py-10 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 w-full w-[200%] mx-auto bg-white border border-[#378BA6] border-opacity-50 shadow-lg rounded-br-lg rounded-bl-lg">
