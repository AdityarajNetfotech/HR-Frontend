    ...
    return (
        <div className={`flex flex-col h-[1101px] rounded-r-xl bg-[var(--Teal,#378BA6)] text-white ${isOpen ? 'w-64' : 'w-20'} transition-all duration-300`}>
            ...
            <nav className="flex flex-col flex-grow mt-10">
                <NavItem to="/AdminDashboard" icon={<FaHome />} label="Dashboard" isOpen={isOpen} />
                <NavItem to="/Adminjds" icon={<FaComments />} label="JD Master" isOpen={isOpen} />
                <NavItem to="/AdminEmployerMaster" icon={<FaComments />} label="Employer Master" isOpen={isOpen} />
                <NavItem to='/AdminRecruterMaster' icon={<FaComments />} label="Recruiter Master" isOpen={isOpen} />
                <NavItem icon={<FaMoneyBill />} label="Chat Support" isOpen={isOpen} />
                <NavItem to="/Admin/Finance" icon={<FaCog />} label="Finances" isOpen={isOpen} />
                <NavItem to="/Admin/Profile" icon={<FaInfoCircle />} label="Profile" isOpen={isOpen} />
                <NavItem to="/Admin/About-Us" icon={<FaInfoCircle />} label="About" isOpen={isOpen} />
                <NavItem
                    icon={<FaSignOutAlt />}
