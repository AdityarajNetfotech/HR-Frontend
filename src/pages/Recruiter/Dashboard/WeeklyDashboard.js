      ...
      <div className='flex flex-col items-start gap-3 py-2 px-4 rounded-br rounded-bl shadow-lg mb-6 bg-white'>
        ...
        <div className='flex flex-col justify-center items-center gap-4 self-stretch'>
          <div className="flex flex-row w-[100%] items-center gap-3">
            ...
            <div className='flex p-[11.796px] items-center gap-[17.693px] flex-1 rounded-[5.898px] bg-[#FBEFD0] w-[325px] h-[55px]'>
              <h1 className='text-[#378BA6] text-center font-jost text-[36px] font-medium leading-[41.285px]'>7</h1>
              <div className='w-[0.737px] h-[42px] bg-[#848484]'></div>
              <h1 className='text-[#4F4F4F] font-jost text-[23.591px] font-normal leading-[30.669px] tracking-[0.118px]'>Locked JD’s </h1>
            </div>
            <div className='flex p-[11.796px] items-center gap-[17.693px] flex-1 rounded-[5.898px] bg-[#FBEFD0] w-[325px] h-[55px]'>
              <h1 className='text-[#378BA6] text-center font-jost text-[36px] font-medium leading-[41.285px]'>18</h1>
              <div className='w-[0.737px] h-[42px] bg-[#848484]'></div>
              <h1 className='text-[#4F4F4F] font-jost text-[23.591px] font-normal leading-[30.669px] tracking-[0.118px]'>Locked JD’s </h1>
            </div>
          </div>
          <div className="flex flex-row w-[100%] items-center gap-3">
            <div className='flex p-[11.796px] items-center gap-[17.693px] flex-1 rounded-[5.898px] bg-[#FBEFD0] w-[325px] h-[55px]'>
              <h1 className='text-[#378BA6] text-center font-jost text-[36px] font-medium leading-[41.285px]'>9</h1>
              <div className='w-[0.737px] h-[42px] bg-[#848484]'></div>
              <h1 className='text-[#4F4F4F] font-jost text-[23.591px] font-normal leading-[30.669px] tracking-[0.118px]'>Locked JD’s </h1>
            </div>
            <div className='flex p-[11.796px] items-center gap-[17.693px] flex-1 rounded-[5.898px] bg-[#FBEFD0] w-[325px] h-[55px]'>
              <h1 className='text-[#378BA6] text-center font-jost text-[36px] font-medium leading-[41.285px]'>4</h1>
              <div className='w-[0.737px] h-[42px] bg-[#848484]'></div>
              <h1 className='text-[#4F4F4F] font-jost text-[23.591px] font-normal leading-[30.669px] tracking-[0.118px]'>Locked JD’s </h1>
            </div>
            <div className='flex p-[11.796px] items-center gap-[17.693px] flex-1 rounded-[5.898px] bg-[#FBEFD0] w-[325px] h-[55px]'>
              <h1 className='text-[#378BA6] text-center font-jost text-[36px] font-medium leading-[41.285px]'>5</h1>
              <div className='w-[0.737px] h-[42px] bg-[#848484]'></div>
              <h1 className='text-[#4F4F4F] font-jost text-[23.591px] font-normal leading-[30.669px] tracking-[0.118px]'>Locked JD’s </h1>
            </div>
          </div>
